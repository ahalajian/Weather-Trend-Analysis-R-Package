...
file_path <- paste(folder_name, file_name, sep ="/")
read.table( file_path, col.names = cols)


list.files(paste("CRND0103-202404080750/", 2002, sep = ""))
...
list.files(paste("CRND0103-202404080750/", 2002, sep = ""))
data2 <- read.table("CRND0103-202404080750/2000/CRND0103-2000-NC_Asheville_8_SSW.txt", col.names = all_column_names)
data2

col_names <- c("WBANNO", "LST_DATE", "CRX_VN", "LONGITUDE", "LATITUDE", "T_DAILY_MAX", "T_DAILY_MIN", "T_DAILY_MEAN", "T_DAILY_AVG", "P_DAILY_CALC", "SOLARAD_DAILY")


data2[,col_names]


station_name <- strsplit("CRND0103-2000-NC_Asheville_8_SSW.txt", "-|\\.")[[1]][3]
state <- strsplit("CRND0103-2000-NC_Asheville_8_SSW.txt", "-|\\.|_")[[1]][3]

cbind(data2, station_name, state)
